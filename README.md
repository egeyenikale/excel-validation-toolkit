# Excel Validation Toolkit

Toolkit that validates Excel files and reports invalid rows.

## Solved Problem

This project demonstrates a practical portfolio implementation for toolkit that validates excel files and reports invalid rows.
...
- feat: add validation rules for row validation
- feat: add reporting view for error report
